            ...
            <section className="bg-white">
                <div className="container px-6 py-12 mx-auto">
                    <div>
                        ...
                        <h1 className="mt-2 text-2xl font-semibold md:text-3xl text-primary">Chat to our friendly team</h1>
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        <div className="grid grid-cols-1 gap-x-12 gap-y-0 md:grid-cols-2">
                            <div>
                                <span className="inline-block p-3 text-primary rounded-full bg-primary/20">
                                ...
                                <p className="mt-2 text-sm text-primary/70">pushkarprakash0709@gmail.com</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-gray-500">Our friendly team is here to help.</p>
                                <p className="mt-2 text-sm text-primary/70">Start new chat</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-primary/70">100 Smith Street Collingwood VIC 3066 AU</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-primary/70">+1 (555) 000-0000</p>
                            </div>
                        </div>
